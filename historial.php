...
// Consulta de todos los pedidos con los datos del cliente
try {
    $sql = "SELECT 
...
<main>
    ...
    <div class="contenedor-acciones">
        <button onclick="window.location.href='nuevo_pedido.php'" class="btn-principal btn-agregar">
...
async function cambiarEstatus(id, nuevoEstatus) {
    ...
    if (confirmed) {
        try {
            const resp = await fetch("cambiar_estatus_pedido.php", {
                method: "POST",
