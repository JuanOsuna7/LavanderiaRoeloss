...
<body>
    ...
    <script>
        ...
        document.getElementById('usuarioForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?= BASE_URL ?>controllers/user_controller.php?action=create', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (data.status === 'success') {
                    ...
                    setTimeout(() => {
                        window.location.href = '<?= BASE_URL ?>controllers/user_controller.php?action=list';
                    }, 2500);
                } else {
